...
import com.e_health_care.web.doctor.service.AuthenticationServiceDoctor;
...
public class AuthenticationControllerDoctor {

    @Autowired
    private AuthenticationServiceDoctor authService;
